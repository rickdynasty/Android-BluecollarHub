package com.bluecollar.lib.widget.utils;
...
import com.bluecollar.lib.base.utils.DeviceUtils;
...
public class StatusBarUtils {
     ...
     * 是否开启沉浸式状态栏
     */
    public static void openStatusBarImmersiveMode(Activity activity) {
