...
package com.bluecollar.lib.widget.EditText;
...
public class BcEditText extends TextView {
    ...
    public BcEditText(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.bcEditTextStyle);
    }

    public BcEditText(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        mContext = context;

        final TypedArray editAttributes = context.obtainStyledAttributes(attrs, R.styleable.BcEditText, defStyle, 0);
        showClearActionBtn = editAttributes.getBoolean(R.styleable.BcEditText_showClear, true);
        isWhiteBackground = editAttributes.getBoolean(R.styleable.BcEditText_isWhiteBackground, true);
        ...
        if (isWhiteBackground != white) {
            ...
            if (isWhiteBackground) {
                if (mActionDrawables == null) {
                    mActionDrawables = new Drawable[]{mContext.getResources().getDrawable(R.mipmap.ic_password_hidden),
                            mContext.getResources().getDrawable(R.mipmap.ic_password_visiable),
                            mContext.getResources().getDrawable(R.mipmap.ic_clear_del_holo_light),
                            mContext.getResources().getDrawable(R.mipmap.ic_clear_del_hpsd_holo_light),
                            mContext.getResources().getDrawable(R.mipmap.ic_clear_del_vpsd_holo_light),};
                }
            } else {
                if (mActionDrawables_colorBg == null) {
                    mActionDrawables_colorBg = new Drawable[]{mContext.getResources().getDrawable(R.mipmap.ic_password_hidden_colorbg),
                            mContext.getResources().getDrawable(R.mipmap.ic_password_visiable_colorbg),
                            mContext.getResources().getDrawable(R.mipmap.ic_clear_del_holo_light_colorbg),
                            mContext.getResources().getDrawable(R.mipmap.ic_clear_del_hpsd_holo_light_colorbg),
    ...
    public void bcInitDeleteStatus(Context context) {
        if (isWhiteBackground) {
            mActionDrawables = new Drawable[]{context.getResources().getDrawable(R.mipmap.ic_password_hidden),
                    context.getResources().getDrawable(R.mipmap.ic_password_visiable),
                    context.getResources().getDrawable(R.mipmap.ic_clear_del_holo_light),
                    context.getResources().getDrawable(R.mipmap.ic_clear_del_hpsd_holo_light),
                    context.getResources().getDrawable(R.mipmap.ic_clear_del_vpsd_holo_light),};
        } else {
            mActionDrawables_colorBg = new Drawable[]{context.getResources().getDrawable(R.mipmap.ic_password_hidden_colorbg),
                    context.getResources().getDrawable(R.mipmap.ic_password_visiable_colorbg),
                    context.getResources().getDrawable(R.mipmap.ic_clear_del_holo_light_colorbg),
                    context.getResources().getDrawable(R.mipmap.ic_clear_del_hpsd_holo_light_colorbg),
                    context.getResources().getDrawable(R.mipmap.ic_clear_del_vpsd_holo_light_colorbg),};
        }
    ...
    public void onInitializeAccessibilityEvent(AccessibilityEvent event) {
        ...
        event.setClassName(BcEditText.class.getName());
    }

    @Override
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo info) {
        super.onInitializeAccessibilityNodeInfo(info);
        info.setClassName(BcEditText.class.getName());
    }
