...
public class TintActivity extends Activity {
    ...
    void setupViews() {
        ...
        mTintDstView1.setImageBitmap(BitmapFactory.decodeResource(getResources(), R.mipmap.btn_check_off));
        mTintDstView2.setImageBitmap(BitmapFactory.decodeResource(getResources(), R.mipmap.btn_check_on));
        mTintDstView3.setImageBitmap(BitmapFactory.decodeResource(getResources(), R.mipmap.btn_radio_off));
        mTintDstView4.setImageBitmap(BitmapFactory.decodeResource(getResources(), R.mipmap.btn_radio_on));
        ...
        Drawable dstDrawable1 = getResources().getDrawable(R.mipmap.btn_check_off);
        dstDrawable1.setColorFilter(mTintSrcColor1, PorterDuff.Mode.SRC_IN);
        Drawable dstDrawable2 = getResources().getDrawable(R.mipmap.btn_check_on);
        dstDrawable2.setColorFilter(mTintSrcColor2, PorterDuff.Mode.SRC_IN);
        Drawable dstDrawable3 = getResources().getDrawable(R.mipmap.btn_radio_off);
        dstDrawable3.setColorFilter(mTintSrcColor3, PorterDuff.Mode.SRC_IN);
        Drawable dstDrawable4 = getResources().getDrawable(R.mipmap.btn_radio_on);
